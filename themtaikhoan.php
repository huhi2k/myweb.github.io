        ...
        <div class="contain">
            ...
            <div class="grid">
                ...
                <div class="contain-content-user">
                    ...
                    <h2 class="text-center text-danger fs21 m-b-15">Thông tin tài khoản</h2>
                    <form action="themtaikhoan.php" method="POST" style="width: 600px;margin: auto;text-align: center;">
                        ...
                        ?>">
                            ...
                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Tên tài khoản:</span><input type="text" name="tentaikhoan" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo  $txttentaikhoan ; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Mật khẩu:</span><input type="text" name="matkhau" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $txtmatkhau ; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Giá hiện tại:</span><input type="text" name="giahientai" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $giahientai; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Giá cũ:</span><input type="text" name="giacu" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $giacu; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Số tướng:</span><input type="text" name="sotuong" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $sotuong; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Số trang phục:</span><input type="text" name="sotrangphuc" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $sotrangphuc; ?>">
                            </div>
...
>                            </div>
                            ...
                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Giảm giá:</span><input type="text" name="giamgia" style="border-radius: 2px;border: 1px solid #dbdbdb;float: right;height: 20px;width: 400px;" value="<?php echo $giamgia; ?>">
                            </div>

                            <div style="width: 90%;height: 24px;margin: 5px;">
                                <span style="font-weight: bold;color: rgba(220,53,59,0.7);float: left;">Ảnh:</span><input type="file" name="anh" style="float: right;height: 20px;width: 400px;" value="<?php echo $txtanh; ?>">
                            </div>

                            <div style="display: flex; justify-content: space-between;width: 50%;margin: 0 auto;height: 30px;">
                                <button type="submit" name="submit" style="background-color: #fea737;color: #280500;cursor: pointer;">Thêm</button>
