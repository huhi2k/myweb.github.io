    ...
    <div class="modal_body"> 
        ...
        <div class="login fail">
            ...
            <div class="login fail-text">
                Số dư của bạn không đủ! Hãy nạp thêm để tiếp tục giao dịch
            </div>
                ...
                <div class="login fail-btn">
                    ...
                    <?php
                        foreach ($data as $value){
                            ...
                            echo '<a href="chitiettaikhoanlogin.php?email='.$value['email'].'&level='.$value['level'].'&id='.$value1['id'].'" class="content-link" style="color: white;"><button class="btn-confirm">OK</button></a>';
                        }
                    ?>
                    <?php endforeach; ?>
                </div>
