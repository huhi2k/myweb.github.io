        ...
        <div class="contain">
            ...
            <div class="grid">
                ...
                <div class="contain-content-user">
                    ...
                    <h2 class="text-center text-danger fs21 m-b-15">Danh sách tài khoản</h2>
                    ...
                    <div style="max-width: 100%;overflow: auto">
                        <table class="table text-center table-bordered">
                            ...
                            <tbody>
                            <?php
                                $sql1="SELECT*FROM account order by id";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value1['giahientai']?> đ</td>
                                    <td><?php echo $value1['giacu']?> đ</td>
                                    <td><?php echo $value1['sotuong']?></td>
                                    <td><?php echo $value1['sotrangphuc']?></td>
                                    <td><?php echo $value1['rank']?></td>
                                    <td><?php echo $value1['sale']?>%</td>
                                    <td><img src="asset/img/<?php echo $value1['anh'] ?>" alt="" style="width: 200px ;"></td>
                                    <td>
                                        <?php
                                            foreach ($data as $value){
                                                echo '<a href="suataikhoan.php?id='.$value1['id'].'&email='.$value['email'].'&level='.$value['level'].'"class="content-link">Sửa</a>';
                                            }
                                        ?>
                                    ...
                                    <td>
                                        <?php
                                            foreach ($data as $value){
                                                echo '<a href="xoataikhoan.php?id='.$value1['id'].'&email='.$value['email'].'&level='.$value['level'].'"class="content-link">Xóa</a>';
                                            }
                                        ?>
                                    </td>
