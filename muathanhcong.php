...
<?php            
    $id=$_REQUEST['id'];
    $sql1="SELECT*FROM account_sold where id='$id'";
        ...
        <div class="modal_body"> 
            ...
            <div class="login success">
                ...
                <div class="login success-text">
                    Đã mua tài khoản thành công
                </div>
                ...
                <div class="login success-footer">
                    <div class="login success-btn">
                        ...
                        foreach ($data as $value){
                            ...
                            echo '<a href="taikhoandamua.php?email='.$value['email'].'&level='.$value['level'].'&id='.$value1['id'].' " class="content-link" style="color: white;"><button class="btn-confirm">OK</button></a>';
