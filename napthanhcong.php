                ...
                <div class="login success-footer">
                    <div class="login success-btn">
                        ...
                        foreach ($data as $value){
                            ...
                            echo '<a href="thongtinuser.php?email='.$value['email'].'&level='.$value['level'].'" class="content-link" style="color: white;"><button class="btn-confirm">OK</button></a>';
