                ...
                <div class="contain-content-user">
                    <div class="desc m " style="font-style: italic">
                        <div class="price d-flex align-items-center">
                            ...
                            <?php
                                foreach ($data as $value){
                                    echo '<strong class="price-new fs24 m-r-15">'.$value['giahientai'].' đ</strong>
                                    <span class="price-old ">'.$value['giacu'].' đ</span>';
                                }
                            ?>
                        </div>
                        <div class="buttonGroup m-t-20">
                            <a href="dangnhap.php"><button class="btn btn-success m-r-10">Đăng nhập để mua nick
                            </button></a>
                        </div>
                    </div>
                    <ul class="nav nav-pills nav_custom" id="tab_detail" role="tablist">
                        ...
                        <li class="border-x-white">
                            <?php
                                foreach ($data as $value){
                                    echo '<a class="nav-link" >Tướng ('.$value['sotuong'].')</a>';
                                }
                            ?>
                        </li>
                        <li class="border-y-white">
                            <?php
                                foreach ($data as $value){
                                    echo '<a class="nav-link" >Trang phục ('.$value['sotrangphuc'].')</a>';
                                }
                            ?>
